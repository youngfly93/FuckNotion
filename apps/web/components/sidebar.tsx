              ...
              return (
                <div key={slug} className="space-y-1">
                  ...
                  >
                    ...
                    <div className="flex items-center flex-1">
                      ...
                      {hasSubPages && (
                        <Button
                          variant="ghost"
                          size="sm"
                          className="neo-button h-6 w-6 p-0 mr-1 bg-yellow-400 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:bg-red-500 transition-colors"
                          onClick={(e) => {
                            e.preventDefault();
                            e.stopPropagation();
                        ...
                        >
                          {isCollapsed ? <ChevronRight className="h-3 w-3 font-bold" /> : <ChevronDown className="h-3 w-3 font-bold" />}
                        </Button>
                      )}
                      {/* Page Link */}
                    ...
                    <button
                      className="h-7 w-7 p-1 bg-red-500 text-white hover:bg-black border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-150 transform hover:scale-110"
                      onClick={(e) => {
